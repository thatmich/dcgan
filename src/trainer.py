...
class Trainer(object):
    ...
    def train_step(self, real_imgs, fake_imgs, BCE_criterion):
        ...
        *   Returns:
        ...
        # TODO START		
        loss_D_real = BCE_criterion(self._netD(real_imgs), torch.ones_like(self._netD(real_imgs)))
        ...
        loss_D_fake = BCE_criterion(self._netD(fake_imgs_detached), torch.zeros_like(self._netD(fake_imgs_detached)))
        D_G_z1 = self._netD(fake_imgs_detached).mean()
        ...
        # record average D(fake_imgs)
        # TODO START
        loss_G = BCE_criterion(self._netD(fake_imgs), torch.ones_like(self._netD(fake_imgs)))
